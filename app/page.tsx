            ...
            <Carousel className="mx-10 my-12">
              <CarouselContent>
                {[
                  ...
                  >
                    <Card className="group cursor-pointer hover:drop-shadow-md hover:bg-primary/10">
        ...
        <div className="container mx-auto max-w-screen-xl">
          ...
          <ZoomInAnimation className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            {[1, 2, 3, 4, 5, 6].map((project) => (
              <Card
                key={project}
                className="overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-lg cursor-pointer"
              >
                <Image
